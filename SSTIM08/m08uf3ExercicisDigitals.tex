...
\title{Problemes de L\`ogica Combinacional}

\author{Departament d' Electr\`onica}
...
\begin{abstract}
Problemes de L\`ogica Combinacional corresponents a la tercera unitat formativa del m\`odul M08 Elements de sistemes de telecomunicacions.
\end{abstract}
...
\subsection{Simplificació de funcions}
